...
function createMap(earthquakes, tectonicPlates, heat) {
  ...
  mainMap.attributionControl.setPosition("bottomleft").addAttribution(`
    <div class="footer-author">&copy; ${new Date().getFullYear()} Bryan Johns.</div>
    <div class="footer-links"> 
      <a href="https://informedwanderer.com" target="_blank" aria-label="Portfolio"><i class="fas fa-laptop"></i> Portfolio</a> | 
    ...
    <div class="footer-tagline">Fluent in Data. Fluent in Human.</div>
  `);
}
